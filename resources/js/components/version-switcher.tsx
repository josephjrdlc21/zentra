import { Check, ChevronsUpDown, PocketKnife } from 'lucide-react';
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground">
                            <div className="flex aspect-square size-8 items-center justify-center rounded-xl bg-sidebar-primary dark:bg-primary text-sidebar-primary-foreground">
                                <PocketKnife className="size-4" />
                            </div>
                            <div className="flex flex-col gap-0.5 leading-none">
                                <span className="font-medium">Zentra</span>
                            </div>
