...
import { index, store } from "@/routes/portal/roles";
...
export default function Create({ values }: { values: Role }){
    ...
    return(
        <Main>
            <Head title={values.page_title}>
                <meta name="description" content="Create role for Zentra app." />
            </Head>

            <form onSubmit={handelSubmit} className="w-full flex justify-center">
                <Card className="w-full max-w-2xl">
                    <CardHeader>
                        <CardTitle className="text-lg">Create role form</CardTitle>
